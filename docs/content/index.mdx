...
## See it in action
 ...
 NIKI's terminal UI has 14 distinct views. Here are the most important ones:

| Live pipeline | Unified diff | Cost breakdown | Verdict |
|:---:|:---:|:---:|:---:|
| ![Run](/screenshots/page-run.png) | ![Diff](/screenshots/page-diff.png) | ![Cost](/screenshots/page-cost.png) | ![Verdict](/screenshots/page-verdict.png) |

| Agent transcripts | Mission fleet | Configuration | Keybindings |
|:---:|:---:|:---:|:---:|
| ![Agents](/screenshots/page-agents.png) | ![Fleet](/screenshots/page-fleet.png) | ![Config](/screenshots/page-config.png) | ![Help](/screenshots/page-help.png) |

| Permission modal | Command palette | Onboarding |
|:---:|:---:|:---:|
| ![Permission](/screenshots/permission-modal.png) | ![Palette](/screenshots/command-palette.png) | ![Onboarding](/screenshots/onboarding-step1.png) |
