...
* **OpenCode Zen:** One-key gateway (MiniMax, GLM, Kimi models, free tiers) — see [AI Gateways](./06-ai-gateways).
* **Kimi Code:** Moonshot's coding gateway (`k3-256k`) — see [AI Gateways](./06-ai-gateways).
* **KiloCode Gateway:** Hundreds of models as `vendor/model` behind one key — see [AI Gateways](./06-ai-gateways).
